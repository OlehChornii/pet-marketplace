// client/src/pages/Cats/CatDetail.jsx
    ...
    <div style={styles.pageWrap}>
      <style>{`
        @media (max-width: 880px) {
          .cd-card { flex-direction: column; padding: 1rem; }
          .cd-image { height: 320px; }
          .cd-info { padding: 1rem; }
          .cd-title { font-size: 1.8rem; }
        }
      `}</style>

      <button aria-label="Назад" onClick={() => navigate(-1)} style={styles.back}>← Назад</button>

      <div className="cd-card" style={styles.card}>
        <div className="cd-image" style={styles.imageColumn}>
          {mainImage ? (
        ...
        <div className="cd-info" style={{ ...styles.infoColumn, minHeight: 420 }}>
          <div style={styles.headerRow}>
            <h1 className="cd-title" style={styles.title}>{pet.name}</h1>
