// client/src/pages/Others/OthersList.jsx
...
const OthersList = () => {
  ...
  const fetchPets = useCallback(async () => {
    try {
      ...
      const response = await petsAPI.getByCategory('other', params);
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>🐰 Інші тварини</h1>
        <div style={styles.nav}>
          <Link to="/others/list" style={styles.navLinkActive}>
            Список
          </Link>
          <Link to="/others/breeds" style={styles.navLink}>
            Види
          </Link>
          <Link to="/others/articles" style={styles.navLink}>
            Статті
          </Link>
        </div>
      </div>
      ...
      <div style={styles.content}>
        <aside style={styles.sidebar}>
          ...
          <div style={styles.filterGroup}>
            <label style={styles.label}>Порода / Вид</label>
            <select
              value={filters.breed}
            ...
            <>
              <div style={styles.resultsHeader}>
                <p style={styles.resultsCount}>
                  Знайдено: <strong>{pets.length}</strong> {pets.length === 1 ? 'тварина' : pets.length < 5 ? 'тварини' : 'тварин'}
                </p>
              </div>
